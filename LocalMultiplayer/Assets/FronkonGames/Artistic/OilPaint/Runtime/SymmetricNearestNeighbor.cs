...
namespace FronkonGames.Artistic.OilPaint
{
  ...
  public sealed class SymmetricNearestNeighbor : ScriptableRendererFeature
  {
    ...
    public sealed class Settings
    {
      ...
      /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      #region Symmetric Nearest Neighbor settings.
    ...
    private static readonly SymmetricNearestNeighbor[] NoEffects = new SymmetricNearestNeighbor[0];
    ...
    /// <remarks> This function use Reflection, so it can be slow. </remarks>
    public static SymmetricNearestNeighbor Instance
    {
      get
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          {
            if (scriptableRendererData.rendererFeatures[i] is SymmetricNearestNeighbor)
              return scriptableRendererData.rendererFeatures[i] as SymmetricNearestNeighbor;
          }
        }
    ...
    /// <remarks> This function use Reflection, so it can be slow. </remarks>
    private static SymmetricNearestNeighbor[] Instances
    {
      get
      {
        if (UniversalRenderPipeline.asset != null)
        {
          ...
          List<SymmetricNearestNeighbor> effects = new();
          for (int i = 0; i < rendererDataList.Length; ++i)
          {
            if (rendererDataList[i] != null && rendererDataList[i].rendererFeatures.Count > 0)
              foreach (var feature in rendererDataList[i].rendererFeatures)
                if (feature is SymmetricNearestNeighbor)
                  effects.Add(feature as SymmetricNearestNeighbor);
          }
