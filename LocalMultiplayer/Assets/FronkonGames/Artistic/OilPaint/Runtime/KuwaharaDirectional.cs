...
namespace FronkonGames.Artistic.OilPaint
{
  ...
  ///------------------------------------------------------------------------------------------------------------------
  [DisallowMultipleRendererFeature("Oil Paint: Kuwahara Directional")]
  public sealed class KuwaharaDirectional : ScriptableRendererFeature
  {
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
      ...
      if (material == null)
      {
        string shaderPath = $"Shaders/KuwaharaDirectional_URP";
    ...
    public sealed class Settings
    {
      ...
      /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      #region Kuwahara Directional settings.
    ...
    private static readonly KuwaharaDirectional[] NoEffects = new KuwaharaDirectional[0];
    ...
    /// <remarks> This function use Reflection, so it can be slow. </remarks>
    public static KuwaharaDirectional Instance
    {
      get
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          {
            if (scriptableRendererData.rendererFeatures[i] is KuwaharaDirectional)
              return scriptableRendererData.rendererFeatures[i] as KuwaharaDirectional;
          }
        }
    ...
    /// <remarks> This function use Reflection, so it can be slow. </remarks>
    private static KuwaharaDirectional[] Instances
    {
      get
      {
        if (UniversalRenderPipeline.asset != null)
        {
          ...
          List<KuwaharaDirectional> effects = new();
          for (int i = 0; i < rendererDataList.Length; ++i)
          {
            if (rendererDataList[i] != null && rendererDataList[i].rendererFeatures.Count > 0)
              foreach (var feature in rendererDataList[i].rendererFeatures)
                if (feature is KuwaharaDirectional)
                  effects.Add(feature as KuwaharaDirectional);
          }
