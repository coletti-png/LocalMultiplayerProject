...
namespace FronkonGames.Artistic.OilPaint
{
  ...
  ///------------------------------------------------------------------------------------------------------------------
  [DisallowMultipleRendererFeature("Oil Paint: Kuwahara Generalized")]
  public sealed class KuwaharaGeneralized : ScriptableRendererFeature
  {
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
      ...
      if (material == null)
      {
        string shaderPath = $"Shaders/KuwaharaGeneralized_URP";
    ...
    public sealed class Settings
    {
      ...
      /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      #region Kuwahara Generalized settings.
    ...
    private static readonly KuwaharaGeneralized[] NoEffects = new KuwaharaGeneralized[0];
    ...
    /// <remarks> This function use Reflection, so it can be slow. </remarks>
    public static KuwaharaGeneralized Instance
    {
      get
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          {
            if (scriptableRendererData.rendererFeatures[i] is KuwaharaGeneralized)
              return scriptableRendererData.rendererFeatures[i] as KuwaharaGeneralized;
          }
        }
    ...
    /// <remarks> This function use Reflection, so it can be slow. </remarks>
    private static KuwaharaGeneralized[] Instances
    {
      get
      {
        if (UniversalRenderPipeline.asset != null)
        {
          ...
          List<KuwaharaGeneralized> effects = new();
          for (int i = 0; i < rendererDataList.Length; ++i)
          {
            if (rendererDataList[i] != null && rendererDataList[i].rendererFeatures.Count > 0)
              foreach (var feature in rendererDataList[i].rendererFeatures)
                if (feature is KuwaharaGeneralized)
                  effects.Add(feature as KuwaharaGeneralized);
          }
