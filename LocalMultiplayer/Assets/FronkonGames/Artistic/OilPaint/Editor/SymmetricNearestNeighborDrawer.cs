...
{
  /// <summary> Symmetric Nearest Neighbor inspector. </summary>
  [CustomPropertyDrawer(typeof(SymmetricNearestNeighbor.Settings))]
  public class SymmetricNearestNeighborDrawer : Drawer
  {
    private SymmetricNearestNeighbor.Settings settings;

    protected override string EffectName => "Symmetric Nearest Neighbor";

    protected override void ResetValues() => settings?.ResetDefaultValues();

    protected override void InspectorGUI()
    {
      settings ??= GetSettings<SymmetricNearestNeighbor.Settings>();
