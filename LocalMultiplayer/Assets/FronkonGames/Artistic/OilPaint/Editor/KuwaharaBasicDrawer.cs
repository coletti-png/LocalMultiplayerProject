...
{
  /// <summary> Kuwahara Basic inspector. </summary>
  [CustomPropertyDrawer(typeof(KuwaharaBasic.Settings))]
  public class KuwaharaBasicDrawer : Drawer
  {
    private KuwaharaBasic.Settings settings;
    ...
    {
      settings ??= GetSettings<KuwaharaBasic.Settings>();
