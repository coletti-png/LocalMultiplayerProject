...
{
  /// <summary> Kuwahara Anisotropic inspector. </summary>
  [CustomPropertyDrawer(typeof(KuwaharaAnisotropic.Settings))]
  public class KuwaharaAnisotropicDrawer : Drawer
  {
    private KuwaharaAnisotropic.Settings settings;

    protected override string EffectName => "Kuwahara Basic";

    protected override void ResetValues() => settings?.ResetDefaultValues();

    protected override void InspectorGUI()
    {
      settings ??= GetSettings<KuwaharaAnisotropic.Settings>();
      ...
      settings.zeroCrossing = Slider("Zero crossing", "How much sectors overlap with each other [0.25, 2]. Default 0.58.", settings.zeroCrossing, 0.25f, 2.0f, 0.58f);
