...
{
  /// <summary> Kuwahara Directional inspector. </summary>
  [CustomPropertyDrawer(typeof(KuwaharaDirectional.Settings))]
  public class KuwaharaDirectionalDrawer : Drawer
  {
    private KuwaharaDirectional.Settings settings;

    protected override string EffectName => "Kuwahara Directional";

    protected override void ResetValues() => settings?.ResetDefaultValues();

    protected override void InspectorGUI()
    {
      settings ??= GetSettings<KuwaharaDirectional.Settings>();
