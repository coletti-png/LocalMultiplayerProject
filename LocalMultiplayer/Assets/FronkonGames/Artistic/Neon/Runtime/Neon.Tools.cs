...
namespace FronkonGames.Artistic.Neon
{
  ...
  public sealed partial class Neon
  {
    ...
    private static readonly Neon[] NoEffects = new Neon[0];
        ...
        if (pipelineAsset != null)
        {
          ...
          for (int i = 0; i < scriptableRendererData.rendererFeatures.Count; ++i)
          {
            if (scriptableRendererData.rendererFeatures[i] is Neon)
              return scriptableRendererData.rendererFeatures[i] as Neon;
          }
        }
